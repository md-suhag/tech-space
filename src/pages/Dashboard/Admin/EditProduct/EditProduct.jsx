...
const EditProduct = () => {
  ...
  async function onSubmit(values) {
    try {
      ...
      const result = await update({ formData, id: productData._id }).unwrap();

      // Show success message
      toast.success(result.message || "Editing successful!");
      form.reset();
  ...
  return (
    <section className=" m-10">
      <h1 className="text-2xl text-center mb-2">Edit Product</h1>
